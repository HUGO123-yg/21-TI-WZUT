...
* 修改记录
* 日期              作者                备注
* 2026-01-09       pudding           first version
********************************************************************************************************************/
/*********************************************************************************************************************
* 接线定义：
*                   ------------------------------------
...
void imu660rb_get_gyro (void)
{
    ...
    imu660rb_gyro_x = (int16)(((uint16)dat[1]<<8 | dat[0])-7);
    imu660rb_gyro_y = (int16)(((uint16)dat[3]<<8 | dat[2])+6);
    imu660rb_gyro_z = (int16)(((uint16)dat[5]<<8 | dat[4])+2);
}
